...
// async function deployTakaturn({ getNamedAccounts, deployments }) {
...
//     log("Deploying Takaturn Diamond...")
...
//     takaturnDiamond = await diamond.deploy("TakaturnDiamond", {
//         from: deployer,
//         owner: deployer,
//         args: args,
//         log: true,
...
!developmentChains.includes(network.name)
    ...
    : describe("Integration tests. End to end", function () {
          ...
          beforeEach(async function () {
              ...
              // Deploy contract
              await deployments.fixture(["ci"])
              console.log("check 1")
              //   takaturnDiamond = await ethers.getContract("TakaturnDiamond_DiamondProxy")
