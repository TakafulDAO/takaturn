...
!developmentChains.includes(network.name)
    ...
    : describe("Diamond unit tests", function () {
          ...
          beforeEach(async () => {
              ...
              // Deploy contracts
              await deployments.fixture(["diamond_storage_deploy"])
              takaturnDiamond = await ethers.getContract("TakaturnDiamondStorage")
              // Connect the users
          ...
          describe("Initialization", function () {
              it("Should get the init values for the Diamond Sorage Library", async function () {
          ...
          describe("Testing the diamond upgrade", function () {
              beforeEach(async () => {
                  await deployments.fixture(["diamond_storage_upgrade"])
